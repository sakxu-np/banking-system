...
function evaluateLoanApplication(loan) {
...
function evaluateCreditScore(creditScore) {
...
function evaluateLoanToIncome(ratio) {
...
function evaluateAccountHistory(months) {
...
function evaluateExistingLoans(count) {
