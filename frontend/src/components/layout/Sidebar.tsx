...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navigation = [
    ...
    { name: "Accounts", to: "/accounts", icon: <AccountsIcon /> },
    { name: "Transfers", to: "/transfers", icon: <TransfersIcon /> },
    { name: "Loans", to: "/loans", icon: <LoansIcon /> },
    { name: "Investments", to: "/investments", icon: <InvestmentsIcon /> },
    { name: "Budget", to: "/budget", icon: <BudgetIcon /> },
  ...
  if (user?.role === "admin") {
    navigation.push({ name: "Admin Panel", to: "/admin", icon: <AdminIcon /> });
  }
    ...
    <>
      ...
      <aside
        className={`
          ...
          bg-gray-800 text-white md:translate-x-0 md:static md:h-screen
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-6">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xl font-bold tracking-wide">AI Banking</span>
          </div>
          <button
        ...
        {/* User info */}
        <div className="flex flex-col items-center px-4 py-5 border-t border-gray-700">
          <div className="w-16 h-16 rounded-full bg-primary-500 flex items-center justify-center mb-3 text-2xl font-bold">
